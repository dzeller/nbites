...
#ifndef OFFLINE
// RESET_POOL_SIZE(messages::WorldModel,  24);
// RESET_POOL_SIZE(messages::JointAngles, 24);
// RESET_POOL_SIZE(messages::InertialState, 16);
// RESET_POOL_SIZE(messages::YUVImage, 16);
// RESET_POOL_SIZE(messages::RobotLocation, 16);
// RESET_POOL_SIZE(messages::Toggle, 16);
#endif
